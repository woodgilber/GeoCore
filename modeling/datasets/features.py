...
class Ingenious_Outline_H3Grid(BaseFeatures):
    ...
    SELECT 
    H3_BLOCKS
    FROM ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.INGENIOUS_GRID_EXTENT
    """
...
class Ingenious_Depth_to_Basement(BaseFeatures):
    ...
    sql_code = """
         SELECT
          ...
          , D2B_METERS
           FROM      
           ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.DEPTH_TO_BASEMENT_GRID_INGENIOUS
    """
...
class Ingenious_CBA_HGM_Gravity(BaseFeatures):
    ...
    sql_code = """
      ...
      , GRAVITY_HGM
      FROM 
      ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.GRAVITY_HGM_GRID_INGENIOUS
    """
...
class Ingenious_Earthquake_Density_n100a15(BaseFeatures):
    ...
    sql_code = """
      ...
      , EQ_DENSITY_N100A151
        FROM 
    ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.EARTHQUAKE_DENSITY_N100A15_GRID_INGENIOUS
      """
...
class Ingenious_MT_Conductance_Layers(BaseFeatures):
    ...
    sql_code = """
      ...
      , CONDUCTANCE_MANTLE
        FROM
      ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.CONDUCTANCE_GRIDS_INGENIOUS
      """
...
class Ingenious_Geodetic_Layers(BaseFeatures):
    ...
    SELECT
        ...
        GEODETIC_SHEAR_RATE       
    FROM
        ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.GEODETIC_GRIDS_INGENIOUS
     """
...
class Ingenious_Heatflow(BaseFeatures):
    ...
    SELECT
        ...
        , HEATFLOW
        FROM 
        ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.HEATFLOW_GRID_INGENIOUS
    """
...
class Ingenious_RTP_HGM_Magnetic(BaseFeatures):
    ...
    SELECT
        ...
        , MAGNETIC_HGM
        FROM 
        ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.MAGNETIC_RTP_HGM_GRID_INGENIOUS 
    """
...
class Ingenious_Quaternary_Volcanics_Distance(BaseFeatures):
    ...
    */
    ...
    WITH ALL_GB_VENTS AS (
        ...
        FROM ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.GB_VENTS_INGENIOUS
...
class Ingenious_Fault_Layers(BaseFeatures):
  ...
  WITH fault_res8 AS (
    ...
    SELECT 
        ...
        SLIPRTNUM,
        RECNUM
    FROM ZANSKAR_SNOWFLAKE_MARKETPLACE_TEST.INGENIOUS.FAULT_GEOMETRY_INGENIOUS
),
